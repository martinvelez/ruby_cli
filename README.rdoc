...
=== Not Rubygems:
1. Download ruby_cli[https://github.com/martinvelez/ruby_cli/downloads]
2. Only the lib folder contents are needed
3. Use the RubyCLI module as a mixin for your CLI application
